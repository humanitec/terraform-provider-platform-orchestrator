...
// Valid indicates whether the value is a known member of the RemoteRunnerMessageAction enum.
func (e RemoteRunnerMessageAction) Valid() bool {
	switch e {
	case CheckJobStatus:
		return true
	case CreateJob:
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r InternalPushMessageToRemoteRunnerResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r WaitForRemoteRunnerMessagesResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
