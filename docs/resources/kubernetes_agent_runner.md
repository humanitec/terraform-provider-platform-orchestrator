...
page_title: "humanitec_kubernetes_agent_runner Resource - humanitec"
subcategory: ""
description: |-
  Kubernetes Agent Runner resource
---

# humanitec_kubernetes_agent_runner (Resource)
...
```shell
terraform import humanitec_kubernetes_agent_runner.my_runner "my-runner"
```
